        ...
        <script type="text/javascript">
            ...
            function pindah(){
                if ((namahari=='Saturday') || (namahari=='Sunday')){
                    //setTimeout(function(){ window.location.href = 'taklim.php?saat=<?php echo $waktu; ?>'; }, 30000); // pindah page stlh 30 detik
                    setTimeout(function(){ window.location.href = 'motivasi2.php?saat=<?php echo $waktu; ?>'; }, 15000);
                } else {
                    setTimeout(function(){ window.location.href = 'jumatan.php?saat=<?php echo $waktu; ?>'; }, 20000); // pindah page stlh 30 detik
                }
                //setTimeout(function(){ window.location.href = 'jumatan.php'; }, 30000); // pindah page stlh 60 detik
            }
        </script>
