        ...
        <script type="text/javascript">
            ...
            function pindah(){
                if ((namahari=='Saturday') || (namahari=='Sunday')){
                    ...
                    setTimeout(function(){ window.location.href = 'motivasi3.php?saat=<?php echo $waktu; ?>'; }, 15000);
                } else {
                    setTimeout(function(){ window.location.href = 'jumatan.php?saat=<?php echo $waktu; ?>'; }, 30000); // pindah page stlh 30 detik
                }
                //setTimeout(function(){ window.location.href = 'motivasi2.php?saat=<?php echo $waktu; ?>'; }, 30000);
            }
        </script>
